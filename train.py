...
def train(model):
    ...
    dataset_train.load_custom("/home/superman/Project/mrcnn_demo/dataset", "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/home/superman/Project/mrcnn_demo/dataset", "val")
    dataset_val.prepare()
